...
from src.forecaster.data_generation.config import BASE_CONSUMPTION, TZ

logger = logging.getLogger(__name__)


# ---------------------------------------------------------------------------
# Price model – derives a realistic energy spot price from load/solar data
# ---------------------------------------------------------------------------
def _compute_spot_price(hour: int, month: int, weekday: int, solar_irr: float) -> float:
    ...
    # demand multiplier from residential hourly curve
    ...
    # solar supply pushes price down when abundant
