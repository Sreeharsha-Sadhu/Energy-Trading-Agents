# src/data_generation/energy_load_generator.py
import logging
import os
...
class EnergyLoadDataGenerator:
    ...
    def generate_incremental_dataset(
        ...
        # Helper to generate submissions for a date range and submission type
        ...
        # Final submissions (more accurate)
        ...
        # Initial submissions (less accurate)
        ...
        # return sample summary dataframe
        try:
